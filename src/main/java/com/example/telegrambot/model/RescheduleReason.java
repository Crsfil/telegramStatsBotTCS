...
public enum RescheduleReason {
    ...
    НЕТ ДОКУМЕНТОВ("нет документов",    Arrays.asList("нет документов", "нет конверта")),
    ...
    ИНИЦИАТИВА_КЛИЕНТА("Инициатива клиента", Arrays.asList(
            "просит перенести", "попросил перенести", "попросил перенести встречу", "инициатива клиента"
    )),
